...
from A3C_TRADING_ENV import Micro_Arch_4,Micro_Arch_Live_Test,Micro_Arch_Live_TestV2
...
class Q_Network():
    def __init__(self):
        ...
        self.inputs = tf.placeholder(shape=[None,27], dtype=tf.float32)
...
num_episodes = 3100 #Total number of episodes to train network for.
...
tDelay = 1.0
hist_Vals = 3
summary_writer = tf.summary.FileWriter('testing_2')
...
with tf.Session() as sess:
    ...
    while True:
        ...
        print "Mean Reward: " + str(rAll) + " epPercentagePriceChg: " + str(epPercentagePriceChg) + " keep prob: " + str((1 - e) + 0.1)
